...
let responseJSON = '<?php echo $response; ?>';
  ...
  let markup = `
   ...
   <div id="pop" class="modal">
      ...
      <div class="header-style">
        <img class="vertical-aligh d-inline" src="/second/s10/img/logo.png"/>
  ...
  .join(`${response.offer.item.name}`));
        ...
        <button type="button" onclick="questionDisplay(${i +
          1})" class="btn-color hov w-100 mb-2 q${i + 1}">${
  ...
  .join(`${response.offer.item.name}`);
          ...
          imgele.setAttribute("src", "/second/s10/img/loading.gif");
  ...
  .join(`${response.offer.item.name}`)
          ...
          if (tickcounter < kotunori.length) {
            ...
            imgele.setAttribute("src", "/second/s10/img/tick.png");
            ele.appendChild(imgele);
